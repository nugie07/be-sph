...
<head>
	...
	<title>PT Indo Anugerah Sukses Energi - Delivery Note</title>
	<style>
		body {
...
<body>
	<!-- Header Table -->
	<!-- Header dengan Logo IASE di tengah -->
		...
		<tr>
			<td style="text-align: center; padding-top: 10px;">
				<p style="margin: 0; font-size: 11px; line-height: 1.5;">
					World Capital Tower Lt. 05 Unit 01, Jl. Mega Kuningan Barat No. 3, Kuningan Timur, Kec. Setia Budi, Jakarta Selatan 12950<br/>
					Gagah Putera Satria Building, Jl. KP. Tendean No. 158 Banjarmasin, Kalimantan Selatan 70231<br/>
					Email : indosuksesae@gmail.com / Telp. +62 - 811 - 8888 - 2221
				</p>
			</td>
		</tr>
	</table>
	...
	<table width="100%" cellspacing="0" cellpadding="5" style="font-size:14px">
		<tr>
			<td>
				...
				dengan baik dengan segel yang diberikan oleh PT Indo Anugerah Sukses Energi (dalam sosialisasi)
		...
		<tr>
			<td style="width:50%">
				<table class="signature">
					<tr>
						<td colspan="2" style="text-align: center; font-weight:bold">PT INDO ANUGERAH SUKSES ENERGI </td>
					</tr>
					<tr>
						<td style="text-align: center;">
	...
	<table width="100%" cellspacing="0" cellpadding="5" style="font-size:14px">
		<tr>
			<td>
				...
				IASE, 1 rangkap untuk customer, 1 rangkap untuk transportir)
			</td>
		</tr>
	</table>
</body>
