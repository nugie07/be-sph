                ...
                <tr>
                    ...
                    <td style="vertical-align: top;">
                        ...
                        foreach ($oatData as $item) {
                            ...
                            // Format bisa: "46 OAT 10 KL", "OAT 10 KL", "46 SPOB", "SPOB", dll
                            ...
                            // Deteksi type SPOB
                            elseif (stripos($typeString, 'SPOB') !== false) {
                                $groupedByLocation[$location]['spob'] = $totalPrice;
                            }
                        }
                        @endphp
                        ...
                        <table class="tableoat" style="width: auto; border-collapse: collapse;">
                            <thead>
                                <tr>
                                    ...
                                    <th style="border: 1px solid #000; padding: 5px; text-align: center;">OAT 10KL</th>
                                    <th style="border: 1px solid #000; padding: 5px; text-align: center;">SPOB</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="border: 1px solid #000; padding: 5px; text-align: center;">
                                        @if($data['spob'] !== null && $data['spob'] != 0)
                                            {{ number_format($data['spob'], 0, ',', '.') }}
                                        @else
                                            -
                                        @endif
                                    </td>
                                ...
                                @empty
                                <tr>
                                    <td colspan="3" style="border: 1px solid #000; padding: 5px; text-align: center;">Tidak ada data</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
