...
Route::get('/sph/pdf-jobs', [SphController::class, 'pdfJobs']);
Route::post('/sph/{id}/generate-pdf', [SphController::class, 'generatePdf']);
Route::post('/sph/{id}/recreate-pdf', [SphController::class, 'recreateSph']);
Route::get('/sph/{id}/preview-url', [SphController::class, 'previewUrl']);
